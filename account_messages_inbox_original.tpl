    ...
    <!-- IF hide_content != "1" -->
      		...
      		<div class="clearfix">
      				...
      				<div class=" row  <!-- IF message_new -->message_new<!-- ENDIF --> {ifelse:rownum,"1","odd","even"} {ifelse:rowlast,"1","dataitemlast",""}">
                        ...
                        <a href="{top.virtual_path}{message_link}"> <!-- IF message_new --><span class="label label-warning">new</span><!-- ENDIF --> <h4>{member_username}</h4>
                   ...
                   <div class="col-sm-4 col-xs-2">
                          ...
                          <p class="hidden-xs timestamp pull-right text-muted">{message_date} </p>  
                   </div>
